...
class _HomePageState extends State<HomePage>
  ...
  Widget build(BuildContext context) {
    ...
    List<Color> gradientColors = [const Color(0xff373737),const Color(0xff18171c)];
          ...
          body: SafeArea(
              ...
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    begin:const FractionalOffset(0.3,0.7)
                ) 
              ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  TabBar(indicatorColor: Colors.lime, 
                  tabs: [  //Color.fromARGB(255, 53, 205, 61)
                    const Tab(
                      child: Text(
                        'All Pokemons',
                        style: TextStyle(
                          ...
                          if (state is FavoritePokemonLoadingState ||
                            ...
                            if (state.pokemon!.isEmpty) {
                                return Column(
                                  ...
                                  children: [
                                    const Text('No Favorites.',style: TextStyle(color: Colors.white,fontSize: 32)),
                                    const SizedBox(height: 25,),
                                    const Icon(Icons.block,size: 82,color: Colors.white,)
                                  ],
                              );
                            }
